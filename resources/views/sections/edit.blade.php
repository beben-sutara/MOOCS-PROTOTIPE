...
@section('title', 'Edit Bab - ' . $section->title)
        ...
        <div class="card mb-4" style="border-left: 4px solid var(--primary);">
            <div class="card-body p-4">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div>
                        <h4 class="fw-bold mb-1">Edit Bab (Section)</h4>
                        <p class="text-muted mb-0">
                            Perbarui judul atau deskripsi bab ini. Modul yang sudah tergabung dalam bab ini tidak akan terpengaruh.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body p-4">
                @include('sections.form', [
                    'submitLabel' => 'Perbarui Bab',
                    'action'      => route('sections.update', [$course, $section]),
                    'method'      => 'PUT',
                ])
            </div>
        </div>
